...
#define MAX_APPLICATION_SPEED_RPM       12798 /*!< rpm, mechanical */
...
#define PID_TORQUE_KP_DEFAULT         759       
#define PID_TORQUE_KI_DEFAULT         370
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           759
#define PID_FLUX_KI_DEFAULT           370
...
#define PID_SPEED_KP_DEFAULT          2039/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT          704/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define DEFAULT_CONTROL_MODE           STC_SPEED_MODE /*!< STC_TORQUE_MODE or 
                                                        STC_SPEED_MODE */
#define DEFAULT_TARGET_SPEED_RPM      2090
...
#define PHASE3_FINAL_CURRENT           8021
/* Phase 4 */
#define PHASE4_DURATION                4644 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT         (2322*SPEED_UNIT/_RPM)
#define PHASE4_FINAL_CURRENT           8021
/* Phase 5 */
#define PHASE5_DURATION                0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT         (2322*SPEED_UNIT/_RPM)
#define PHASE5_FINAL_CURRENT           8021

#define ENABLE_SL_ALGO_FROM_PHASE      1
/* Sensor-less rev-up sequence */
#define STARTING_ANGLE_DEG             0  /*!< degrees [0...359] */                                                             
/* Observer start-up output conditions  */
#define OBS_MINIMUM_SPEED_RPM          2090
